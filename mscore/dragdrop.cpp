...
void ScoreView::dragSymbol(const QPointF& pos)
      ...
      if (e && (e->type() == Element::NOTE || e->type() == Element::SYMBOL || e->type() == Element::IMAGE || e->type() == Element::SPATIALIZATION_SYMBOL)) {
...
void ScoreView::dragMoveEvent(QDragMoveEvent* event)
      ...
      if (dragElement) {
            switch(dragElement->type()) {
                  ...
                  case Element::IMAGE:
                  case Element::SYMBOL:
                  case Element::SPATIALIZATION_SYMBOL:
                        dragSymbol(pos);
                        break;
                  case Element::KEYSIG:
                  case Element::CLEF:
                  ...
                  case Element::SPATIALIZATION_MODIFIER:
                        {
