...
static const char* elementNames[] = {
      ...
      QT_TRANSLATE_NOOP("elementName", "SpatializationSymbol"), //Must be in sync with mscore.h:157 !
      QT_TRANSLATE_NOOP("elementName", "SpatializationModifier"), //Must be in sync with mscore.h:157 !
...
Element* Element::create(ElementType type, Score* score)
      ...
      switch(type) {
            ...
            case SPATIALIZATION_SYMBOL: return new SpatSymbol(score);
            case SPATIALIZATION_MODIFIER: return new SpatModifier(score);
