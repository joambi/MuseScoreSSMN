...
static const PropertyData propertyList[] = {
      ...
      { P_DURATION, "duration", T_REAL },
      { P_START_POSITION, "startPosition", T_POINT },
      { P_CENTER_POSITION, "centerPosition", T_POINT },
      { P_RADIUS, "radius", T_REAL },
      { P_INNER_RADIUS, "innerRadius", T_REAL },
      { P_SPAT_DIRECTION, "direction", T_INT },
      { P_ROTATIONS, "rotations", T_INT },
      { P_START_ANGLE, "startAngle", T_REAL },
      { P_STOP_ANGLE, "stopAngle", T_REAL },
      { P_OSC_MESSAGE_1, "oscMessage1", T_INT },
      { P_OSC_MESSAGE_2, "oscMessage2", T_INT },
